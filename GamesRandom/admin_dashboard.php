            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-none d-md-block">
                        <h5>Stray </h5>
                        <p>
                        Stray es un juego de aventuras de un gato en tercera persona ambientado en los callejones iluminados por el neón de una ciberciudad decadente y sus turbios rincones.</p>
                    </div>
                </div>
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-none d-md-block">
                        <h5>Diablo</h5>
                        <p>Diablo es el RPG de acción definitivo en el que tendrás que acabar con incontables males, dominar un sinfín de habilidades, superar mazmorras de pesadilla y coleccionar botín legendario.</p>
                    </div>
                </div>
            </div>
